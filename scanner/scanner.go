...
var TokDescs = [...]string{
	...
	TOK_EQ:           "Assign ('=')",
	TOK_PLUS_EQ:      "Plus Equals ('+=')",
	TOK_MINUS_EQ:     "Minus Equals ('-=')",
	TOK_STAR_EQ:      "Times Equals ('*=')",
	TOK_STAR_STAR_EQ: "Exponent Equals ('**=')",
	TOK_F_SLASH_EQ:   "Divide Equals ('/=')",
	TOK_PERCENT_EQ:   "Mod Equals ('%=')",
	TOK_AMPERSAND_EQ: "Bit And Equals ('&=')",
	TOK_CARROT_EQ:    "Bit Xor Equals ('^=')",
